...
<style>
    ...
    .form-select { padding:10px 12px; border:1px solid #e6eef8; border-radius:6px; width:100%; max-width:520px }
...
<div class="panel">
    ...
    <form method="POST" action="{{ route('admin.departments.assign_hod.store', $department->department_id) }}">
        ...
        <div class="form-actions">
            <button type="submit" name="submit" class="btn">Assign HoD</button>
