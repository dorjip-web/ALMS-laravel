                ...
                <header class="topbar">
                    ...
                    <div class="logout">
                        <form method="POST" action="/logout" style="display:inline;">
                            @csrf
                            <button type="submit"
                                style="background:#fff;padding:8px 12px;border-radius:6px;border:none;color:var(--orange);font-weight:600;cursor:pointer;">Logout</button>
                        </form>
                    </div>
                </header>
                ...
                <script>
                    (function() {
                        ...
                        function setActiveByHref() {
                            links.forEach(a => a.classList.toggle('active', a.href === window.location.href || a.getAttribute(
